...
void Phase::loadMap(std::string pathToTilemap)
{
	...
	/* Lógica inspirada pelo canal CodingMadeEasy: https://www.youtube.com/watch?v=TsiiW18vz-4 */
...
void Phase::render()
{
	...
	/* Renderiza apenas uma porção da janela onde o jogador se encontra para evitar quedas de perfomance */
	...
	// Renderia os obstáculos e inimigos (e os projéteis do arqueiro)
	...
	// Renderiza os blocos e as plataformas
