...
{
	// Quando o chefão leva dano do jogador, o ataque dele aumenta
	if ((this->gotHit / 175) >= 2) {
		this->damage += madnessCoefficient;
	}

	// o atributo attackTimer controla o tempo para o chefão executar o ataque
...
{
	// Quando o chefão estiver próximo de atacar, sua textura fica avermelhada para avisar o jogador de seu ataque
